                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('grades.index')}}">{{__('Grades List')}}</a></li>
                        </ul>
                    </li>
                    <!-- menu item calendar-->
                    <li>
                        ...
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('classrooms.index')}}">{{__('list classes')}}</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('sections.index')}}">{{__('Academic departments')}}</a></li>
                        </ul>
                    </li>
                    <!-- menu item chat--> 
                    <li>
                        <a href="chat-page.html"><i class="ti-comments"></i><span class="right-nav-text"> {{__('students')}} </span></a>
                    </li>
                    <!-- menu item mailbox-->
                    <li>
                        <a href="mail-box.html"><i class="ti-email"></i><span class="right-nav-text"> {{__('teachers')}} </span></a>
                    </li>
                     <!-- Parents-->
                     <li>
                        ...
                        <ul id="Parents-menu" class="collapse" data-parent="#sidebarnav">
                            {{-- <li> <a href="#">{{__('List Parents')}}</a> </li> --}}
                            <li> <a href="{{route('create.parent')}}">{{__('List Parents')}}</a> </li>
                        </ul>
                    </li>
                    <!-- menu item Charts-->
                    <li>
